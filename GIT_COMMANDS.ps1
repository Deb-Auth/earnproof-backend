# PowerShell script to commit and push the signed webhooks feature

Set-Location c:\Users\RAVE\Desktop\aimer2\earnproof-backend
...
Write-Host "✓ Branch created, changes committed, and pushed to origin" -ForegroundColor Green
Write-Host "✓ Branch: feat/signed-webhooks" -ForegroundColor Green
Write-Host "✓ Commit message: feat(api): add signed webhook delivery" -ForegroundColor Green
